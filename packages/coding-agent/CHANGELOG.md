...
- Fixed custom task agents configured with `model: inherit` failing before their first prompt and preserved explicit thinking suffixes when inheriting the active session model.
